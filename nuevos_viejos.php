...
$sql = "SELECT * FROM cliente ORDER BY fecha_registro ASC";
$result = mysqli_query($conn, $sql);

if ($result) {
  echo "<div class = 'contenedor-tablas'>";
  echo "<h2>Clientes Ordenados del mas viejo de registro</h2>";
  echo "<hr>";
  echo "<table>";
    echo "<tr>";
      echo "<th>ID</th>";
...
if ($result) {
  echo "<div class = 'contenedor-tablas'>";
  echo "<h2>Clientes Ordenados del mas nuevo de registro</h2>";
  echo "<table>";
    echo "<tr>";
      echo "<th>ID</th>";
      echo "<th>Nombre</th>";
